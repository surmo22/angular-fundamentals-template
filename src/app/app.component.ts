...
export class AppComponent implements OnInit, OnDestroy {
  ...
  initLoadingState(): void {
    ...
    // YOUR CODE STARTS HERE
    const combinedValues = combineLatest([this.mockDataService.getCharactersLoader(), this.mockDataService.getPlanetLoader()]).pipe(
        map((value => this.areAllValuesTrue(value)))
    );
    const subscription = combinedValues.subscribe((value :boolean) => this.isLoading = value);
